...
<!--LEs DIRECTEUR ONT  DROIT A CE MENU OU DONNEES , pas les autres -->
...
$requete="SELECT suivi_tache.idtache,emetteur_tache.idemetteur,emetteur_tache.nomemetteur, attributeur_tache.idattributeur,
                              ...
                              FROM suivi_tache 
                                 ...
                                 WHERE      
                                   YEAR(suivi_tache.dateattribution)='$annecours'
                                    AND statut_tache.idstatuttache=$idstatuttache
                                    AND suivi_tache.separer_tache_dj_anac='ANAC'
...
<!--LEs chef de servce/buro ONT  DROIT A CE MENU OU DONNEES , pas les autres -->
...
LEFT JOIN direction_anac ON direction_anac.codedirec=service_anac.codedirec
    ...
    WHERE service_anac.codeserv='$codeserv'  AND   YEAR(suivi_tache.dateattribution)='$annecours'
...
<!--LEs consultants ONT  DROIT A CE MENU OU DONNEES , pas les autres -->
...
<!--LEs autres users cadre  ONT  DROIT A CE MENU OU DONNEES , pas les autres -->
    ...
    while($res=mysqli_fetch_assoc($reponse)){
        ...
        <tr>
            ...
            <!---POUR AFFICHER LES DONNEES-->
                            ...
                            <td style="color:black"> <?php echo  $res['prenag'];?> <?php echo  $res['nomag'];?> à <?php echo  $res['dateheuresaisi'];?></td>
