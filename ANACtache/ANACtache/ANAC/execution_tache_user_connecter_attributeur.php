...
// pour selectioner les differents statuts pour lattributeur connecte, il ne coclure pas

   $req_nomstatuttache="SELECT * 
                          FROM statut_tache  
                             WHERE (idstatuttache=9 OR idstatuttache=10)";
...
<script type="text/javascript" src="jquery.min.js" /></script>
 ...
 &nbsp; &nbsp; &nbsp;
            ...
            Suivi de l'éxecution de la tâche N°:<?php echo  $numeroodre?> du:  <?php echo  $dateattributiontache?> 
             <i>  
                    par <?php echo $nomattributeur ?>:  pour <?php echo  $objettache?>
...
<center><i style="color:red;font-weight:bold">Les champs marqués d'un astérisques(*) sont obligatoire </i></center>
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <form  method="POST" class="form-horizontal" action="update_execution_tache_user_connecter.php" role="form" enctype="multipart/form-data">
        ...
        <select  id ="idemetteur" title="Choissisez Expéditeur dans la liste"   style="color:black;font-weight:bold" class=" form-control selectpicker show-tick " data-size="5"  data-header="Faite votre recherche dans cette zone..." data-live-search="true" data-style="btn-danger" class="form-control" name="idemetteur"  data-rel="chosen" required="required">
           ...
           <!--  <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer green">
                ...
                data-toggle="modal" data-target="#fenetre_modale_emetteur" style="background-color:green;color:white">
                              ...
                              Etape 1: <b><i>Selectionner|Ajouter un Expéditeur</i></b>
            </i> -->
                 ...
                 <div class="col-xs-4 col-sm-4 widget-container-col">
                    <div class="widget-box">
                      <div class="widget-header">
                        <h5 class="widget-title smaller" style="color:#2060a6;font-weight:bold">Personnel Aéronautique:</h5>
        ...
        <select  id ="idpersoaero" title="Choissisez Personnel dans la liste"   style="color:black;font-weight:bold" class=" form-control selectpicker show-tick " data-size="5"  data-header="Faite votre recherche dans cette zone..." data-live-search="true" data-style="btn-primary" class="form-control" name="idpersoaero"  data-rel="chosen">
                    ...
                    <option style="color:black;font-weight:bold" value="<?php echo $nompersoaero['idpersoaero'] ?>"
        ...
        <select  id ="idattributeur" title="Choissisez Attributeur dans la liste"   style="color:black;font-weight:bold" class=" form-control selectpicker show-tick " data-size="5"  data-header="Faite votre recherche dans cette zone..." data-live-search="true" data-style="btn-danger" class="form-control" name="idattributeur"  data-rel="chosen">
                    ...
                    <option  style="color:black;font-weight:bold" value="<?php echo $nomattributeur['idattributeur'] ?>"
        ...
        <select  id ="idorga" title="Choissisez Organisme dans la liste"   style="color:black;font-weight:bold" class=" form-control selectpicker show-tick " data-size="5"  data-header="Faite votre recherche dans cette zone..." data-live-search="true" data-style="btn-primary" class="form-control" name="idorga"  data-rel="chosen">
                    ...
                    <option style="color:black;font-weight:bold" value="<?php echo $nomorga['idorga'] ?>"
        ...
        <select  id ="idaeronef" title="Choissisez Type d'Aéronef | Immatriculation dans la liste"   style="color:black;font-weight:bold" class=" form-control selectpicker show-tick " data-size="5"  data-header="Faite votre recherche dans cette zone..." data-live-search="true" data-style="btn-primary" class="form-control" name="idaeronef"  data-rel="chosen">
                    ...
                    <option style="color:black;font-weight:bold" value="<?php echo $immataeronef['idaeronef'] ?>"
        ...
        <select  id ="iddomaine" title="Choissisez Domaine dans la liste"   style="color:black;font-weight:bold" class=" form-control selectpicker show-tick " data-size="5"  data-header="Faite votre recherche dans cette zone..." data-live-search="true" data-style="btn-primary" class="form-control" name="iddomaine"  data-rel="chosen">
                 ...
                 <option value="<?php echo $iddomaine?>"> <?php echo $nomdomaine?></option>
                    ...
                    <option style="color:black;font-weight:bold" value="<?php echo $nomdomaine['iddomaine'] ?>"
             ...
             <label class="col-sm-1 control-label"><font color="white">Statut Tâche:
                              ...
                              <select  id ="idstatuttache"    style="color:black;font-weight:bold" class=" form-control selectpicker show-tick " data-size="5"  data-header="Selectionner Statut Tâche" data-live-search="true" data-style="btn-danger" name="idstatuttache"  data-rel="chosen" required="required">
                                                      ...
                                                      <option value="<?php echo $idstatuttache?>"> <?php echo $nomstatuttache?></option>
                                                                ...
                                                                <option value=""> Choisir autre Statut Tâche... </option>
                                                                  


                                    <?php while($nomstatuttache=$resu_nomstatuttache->fetch()) { ?>

                    <option style="color:black;font-weight:bold" value="<?php echo $nomstatuttache['idstatuttache'] ?>"
...
<!-- POUR AFFICHER AUTOMATIQUEMENT LA DATE DE CLOTURE QUAND ON CLIQUE LE CHOIX  STATUT=CLOS -->
                    ...
                    <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> <b id="textedatecloture" style="color:red;font-weight:bold"> Date Cloture: </b></label>

                    <!--PAS UTILISE PAR LES ATTRIBUTER, SEUL LES SUPERUSER CLOTURE LA TAHCE-->

                                                     <div class="col-sm-3">
                                                      
                                                    <input type="date" readonly="readonly" title="Date Cloture de la tâche"  value="<?php echo $datecloture?>"  name="datecloture"  id="datecloture"  style="color:red;font-weight:bold" class="form-control">
                                                    ...
                                                    <label class="col-sm-1 control-label"><font color="white">Date courrier/mail:</font></label>
                                                     <div class="col-sm-3">
                                                      
                                                    <input type="date" title="Date courrier/mail reçus" required="required"  value="<?php echo $dateenrgecouranac?>"  name="dateenrgecouranac"  style="color:black;font-weight:bold" class="form-control">
            ...
            <div class="form-group has-success has-feedback">
                                          ...
                                          <label class="col-sm-1 control-label"><font color="white">Date Attribution:</font></label>
                          <div class="col-sm-3">
                                <input type="date" readonly="readonly"  title="Date Attribution de la tâche" required="required" value="<?php echo $dateattribution?>"  name="dateattribution"  style="color:black;font-weight:bold" class="form-control">

                                                    </div>

                                    <label class="col-sm-1 control-label"><font color="white">Objet:</font></label>
                                                     <div class="col-sm-3">
                                                    
                                                    
                                                      <input type="text" readonly="readonly"  name="objettache" value="<?php echo $objettache?>" required="required" style="color:#03224c;background-color:white;font-weight:bold"  class="form-control" >
                                            
                                                    </div>

                                                    <label class="col-sm-1 control-label"><font color="white">Réf.ANAC:</font></label>
                                                     <div class="col-sm-3">
                                                      
                                                         <input type="text" title="N° courrier ANAC"   name="numcourier_ref_anac" placeholder="4572" onkeypress="return keyPressHandler (event);" maxlength="5" value="<?php echo $numcourier_ref_anac?>" style="color:black;font-weight:bold" class="form-control">
        ...
        <select  id ="idformutilise" title="Choissisez Formulaire utilisé dans la liste"   style="color:black;font-weight:bold" class=" form-control selectpicker show-tick " data-size="5"  data-header="Faite votre recherche dans cette zone..." data-live-search="true" data-style="btn-primary" class="form-control" name="formutilise"  data-rel="chosen">
                                    ...
                                    <option value="<?php echo $idformutilise?>"> <?php echo $nomformulaireutilise?></option>
                                                    
                                                                <option value=""> Choisir autre Formulaire... </option>
                                                                   


                                    <?php while($nomformulaireutilise=$resultart_formulaire_utilise_anactache->fetch()) { ?>

                    <option style="color:black;font-weight:bold" value="<?php echo $nomformulaireutilise['idformutilise'] ?>"
                                                     
                                                     <?php if($idformutilise===$nomformulaireutilise['idformutilise']) echo "selected" ?>> 
                                                     
                                                      <?php echo $nomformulaireutilise['nomformulaireutilise'] ?>
                                     </option>
                                    <?php }?>
                          ...
                          <div class="col-sm-3">
                                <input type="date" title="Date Provisionnelle Reponse de la tâche" value="<?php echo $dateprovisiore?>" readonly   name="dateprovisiore"  style="color:black;font-weight:bold" class="form-control">
                          </div>
                          ...
                          <label class="col-sm-1 control-label"><font color="white">Date réunion:
                              ...
                              <input type="date" title="Date réunion, investigation ou Inspection" value="<?php echo $datereunion?>"    name="datereunion"  style="color:black;font-weight:bold" class="form-control">
            ...
            <div class="form-group has-success has-feedback">
                                        ...
                                        <label class="col-sm-1 control-label"><font color="white">Date reprise:
                                                     ...
                                                     <div class="col-sm-3">
                                               <input type="date" title="Date reprise dossier pour complement"  value="<?php echo $datereprisecomplema?>"  name="datereprisecomplema"  style="color:black;font-weight:bold" class="form-control">
                          ...
                          <div class="col-sm-3">
                               <select  id ="suividoc"    style="color:black;font-weight:bold" class=" form-control selectpicker show-tick " data-size="5"  data-header="Selectionner Suivi dossier" data-live-search="true" data-style="btn-primary" name="suividoc"  data-rel="chosen">
                                  ...
                                  <option value="<?php echo $suividoc?>" > <?php echo $suividoc?></option>
                                                       ...
                                                       <option value="">Choisir Autre Suivi dossier </option>

                                               
                                                  <option value="Manque/Signature">Manque/Signature</option>
                          ...
                          <label class="col-sm-1 control-label"><font color="white">Enregistré dans:</font></label>
                                                     <div class="col-sm-3">
        ...
        <select  id ="iddocdelivre" title="Choissisez Document a délivrer dans la liste"   style="color:black;font-weight:bold" class=" form-control selectpicker show-tick " data-size="5"  data-header="Faite votre recherche dans cette zone..." data-live-search="true" data-style="btn-primary" class="form-control" name="documadelivre"  data-rel="chosen">
                                    ...
                                    <option value="<?php echo $iddocdelivre?>"> <?php echo $nomdocdelivre?></option>
                                                    
                                                                <option value=""> Choisir autre Document... </option>
                                                                   


                                    <?php while($nomdocdelivre=$resutl_documadelivre->fetch()) { ?>

                    <option style="color:black;font-weight:bold" value="<?php echo $nomdocdelivre['iddocdelivre'] ?>"
                                                     
                                                     <?php if($iddocdelivre===$nomdocdelivre['iddocdelivre']) echo "selected" ?>> 
                                                     
                                                      <?php echo $nomdocdelivre['nomdocdelivre'] ?>
                                     </option>
                                    <?php }?>
                          ...
                          <div class="col-sm-3">
                                         ...
                                         <input type="text"  value="<?php echo $observation_attribution?>"  name="observation_attribution"  style="color:black;font-weight:bold" class="form-control">
                          </div>

                          <label class="col-sm-1 control-label"><font color="white">Joindre Document:</font></label>
                                                     <div class="col-sm-3">
                            

        <input type="file"  name="fichier"  accept="application/PDF" value="GEDANAC/<?php echo($listedonneeMAJ['file_url'])?>"  style="color:#2060a6;background-color:white;font-weight:bold"   class="form-control" >
            ...
            <div class="form-group has-success has-feedback">
                                          ...
                                          <input type="date" title="Date Reponse  de la tâche"  value="<?php echo $datereponsereltache?>"  name="datereponsereltache"  style="color:black;font-weight:bold" class="form-control">
                             ...
                             <input type="text"   name="observation_retour" value="<?php echo $observation_retour?>"  style="color:#2060a6;background-color:white;font-weight:bold"    class="form-control" >
          ...
          <label class="col-sm-1 control-label"><font color="white">Type de tâche:
              ...
              <div class="col-sm-2">
               ...
               <label class="col-sm-1 control-label"><font color="white">Courrier Entré:</font></label>
                                                     <div class="col-sm-2">
                        ...
                        echo '  <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer yellow"> </i><a onclick="return confirm("Etes vous sûr de vouloir consulter ce Document Integré ?");" target=_blank href="'.$listedonneeMAJ["file_url_courier_entrant"].'"> <img style="width:20px;height:25px; alt="Charisma Logo"  title="Cliquer ici pour consulter le Courrier '.$listedonneeMAJ["file_url_courier_entrant"].'" src="../assets/img/logopdf.jpg">  </a> '.$listedonneeMAJ["file_url_courier_entrant"].' '
                                                         ;}?>
