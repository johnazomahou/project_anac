...
<META HTTP-EQUIV="Refresh" CONTENT="60">
      ...
      <div class="main-content"  >
        <div class="main-content-inner">
          ...
          <h1 style="color:#2060a6;font-weight:bold">
               ...
               Suivi Personnalisé des tâches affectées à :
                <?php echo  ' ' .$_SESSION['user']['prenag']?>
                <?php echo  ' ' .$_SESSION['user']['nomag']?>
              </h1>
 ...
 <div class="alert alert-block alert-warning">
                     ...
                     <center><font face="candara" FONT size="5"> <B>ANALYSES DES INDICATEURS DE PERFORMANCES 
                         DE: <?php echo  ' ' .$_SESSION['user']['prenag']?>
                        <?php echo  ' ' .$_SESSION['user']['nomag']?>
...
<h5 class="widget-title" style="color:#03224c;font-weight:bold">
      ...
      {echo '<h1 style="color:#2060a6;font-weight:bold"> Editions des Etats des Tâches par années et par Statuts de:'.$_SESSION['user']['prenag'].' '.$_SESSION['user']['nomag'].'  </h1>';} 
...
<?php if ($_SESSION['user']['profil']=='Super_Utilisateur') {?>
        ...
        //    <!--POUR AFFICHER LE TABLEAU PAR STATTUS-->
              ...
              include('edition_etats_mestaches_userconnectes.php');
          ?>
...
<h5 class="widget-title" style="color:#03224c;font-weight:bold">
      ...
      {echo '<h1 style="color:#2060a6;font-weight:bold"> Taux Exécution des Tâches par années et par Statuts de: '.$_SESSION['user']['prenag'].' '.$_SESSION['user']['nomag'].'   </h1>';} 
...
<?php if ($_SESSION['user']['profil']=='Super_Utilisateur') {?>
          ...
          //<!--ICI ON CREE LE MENUS ACCESSIBLES PAR LES =Super_Utilisateur-->
              ...
              include_once('tableau_recapt_tache_anne_encours.php');
          ?>
...
<hr><BR/>
                      ...
                      <!--POUR AFFICHER  TOUTES LES VALIDITES DES AUTORISATIONS-->
            <center><strong><b><H1>TABLEAU SYNOPTIQUE DES TACHES DE <?php echo  ' ' .$_SESSION['user']['prenag']?>  
                          <?php echo  ' ' .$_SESSION['user']['nomag']?> </b></H1></strong></center>

                   <?php include('afficher_tableau_mestache_enregistre.php');?>
