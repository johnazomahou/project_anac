...
?>
      ...
      <div class="main-content"  >
        <div class="main-content-inner">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="alert alert-block alert-success">
                     ...
                     <center><font face="candara" FONT size="5"> <B>NOMBRE DE DOSSIER ENVOYE PAR OPERATEUR </B></font></center>
                    ...
                    <div class="clearfix">
                     ...
                     <?php 
                                      require_once("../param_connexion_bdd/connexiobddAJAX.php");
                                        ...
                                        $requete="SELECT suivi_tache.idtache,suivi_tache.idemetteur,emetteur_tache.nomemetteur,
                                                       ...
                                                       (SUM(IF(suivi_tache.idstatuttache=5, 1, 0))) AS tauxexecutioncloture,
                                                        ROUND(((((SUM(IF(suivi_tache.idstatuttache=5, 1, 0)))) / (COUNT(*)))*100),2) AS tauxexecution,
                                                         COUNT(*) AS nbredetache
                                                          ...
                                                          FROM suivi_tache,emetteur_tache 


                                                          WHERE suivi_tache.idemetteur=emetteur_tache.idemetteur 
                                                             AND suivi_tache.separer_tache_dj_anac='ANAC' 
                                                              GROUP BY suivi_tache.idemetteur
                                                              ORDER BY emetteur_tache.nomemetteur ";
                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        <thead>
                          <tr>
                            ...
                            <th style="background-color:#03224c;color:white"><center>Expediteur/Emetteur</center></th>
                            <th style="background-color:#03224c;color:white"><center>Total Dossier à Suivre</center></th>
                            <th style="background-color:#03224c;color:white"><center>Total Dossier Clôturés</center></th>
                            <th style="background-color:#03224c;color:white"><center>Total Dossier Envoyés</center></th>
         ...
         <td><center><?php echo  $res['nomemetteur'];?></center></td>
