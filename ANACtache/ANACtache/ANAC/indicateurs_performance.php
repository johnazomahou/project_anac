...
<h4 class="widget-title" style="color:#03224c;font-weight:bold">
                   ...
                   Analyses Statistiques Mensuelles  des FNC Ouvertes <?php echo date('Y'); ?>  par Catégories
  ...
  <!--POUR inserer image legendeL-->
                                                 
                                                   <center><i><img  src="../assets/img/legendecategoriefnc.png"></i></center>
               
            <!-- /.POUR INCLURE LE FICHIER REPARTITION DES Analyses Statistiques ANNE EN COURS graphique_fnc_categorie_mois.php -->

                      <?PHP   include_once('graphique_fnc_categorie_mois.php');?>
...
<h4 class="widget-title" style="color:#03224c;font-weight:bold">
                          <i class="ace-icon fa fa-bar-chart-o"></i>
                          <i class="menu-icon fa fa-tachometer"></i>
                   Nombre de FNC par Opérateur en <?php echo date('Y'); ?>  et  par Statuts 
            ...
            <!-- /.POUR INCLURE LE FICHIER REPARTITION DES tableau_nbre_fnc_par_operateur.php -->

<?PHP   include_once('tableau_nbre_fnc_par_operateur.php');?>
