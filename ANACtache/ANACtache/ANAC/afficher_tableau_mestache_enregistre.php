...
LEFT JOIN direction_anac ON direction_anac.codedirec=service_anac.codedirec
    ...
    WHERE user_anacstat.numat='$user'  AND  (emetteur_tache.nomemetteur like '%$mc%'  
...
LEFT JOIN direction_anac ON direction_anac.codedirec=service_anac.codedirec
                                ...
                                AND suivi_tache.separer_tache_dj_anac='ANAC'   AND  user_anacstat.numat='$user'  
...
?>
      ...
      <!--POUR METRE LE FORMULAIRE DE RECHECHERE -->
          ...
          <form method="GET" action="mestaches.php">
        ...
        &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp 
                                ...
                                <a title="Pour Afficher la page 0" class="btn btn-warning btn" href="mestaches.php">
...
<!--POUR MISE EN FORME CONDITIONNELLE GERER COULEUr DE FOND du statut d l tache-->
     ...
     <div style="margin-left:30%">
      <ul class="nav nav-pills " style="float:center;">
        <?php 
             if($page>0){ ?>        
                  <li   class="active" > <a  href="mestaches.php?motcle=<?php echo $mc;?>&page=<?php echo(0)?>"><< </a></li>

                  <li  class="active" > <a  href="mestaches.php?motcle=<?php echo $mc;?>&page=<?php echo($page-1)?>">< Précédent</a></li>
          <?php } ?>
        <?php 
          $from=0;
          $max_nbre_page=10;
      //ON AFFICHE 10 ENREGISTEMA PAR PAGE
        ...
        <li class="<?php echo(($i==$page)? 'active':''); ?>">
          <a  href="mestaches.php?motcle=<?php echo $mc;?>&page=<?php echo($i)?>"> <?php echo($i)?></a>
        </li>
        <?php } ?>
         <?php 
             if($page<$Nbrepage){ ?>
             <li class="active"><a  href="mestaches.php?motcle=<?php echo $mc;?>&page=<?php echo($page+1)?>">Suivant ></a></li>
             <li class="active"><a  href="mestaches.php?motcle=<?php echo $mc;?>&page=<?php echo($Nbrepage-1)?>">>></a></li>
           <?php } ?>
      </ul>
      </div>
      <?php }?>
