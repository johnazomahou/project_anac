...
//DECLARATION VARIABLE GESTION DU FICHIER
...
$sql = "UPDATE suivi_tache 
    ...
    SET idattributeur='$idattributeur', numat='$numat',objettache='$objettache',
...
$conn->exec($sql);
 ...
 echo "<script> alert('Enregistrement effectué avec succes.')</script>";

                  echo "<script  type='text/javascript'>document.location.replace('mestaches.php');</script>";
...
echo "<script> alert('Enregistrement effectué avec succes. document joint Conservé')</script>";
