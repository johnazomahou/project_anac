...
?>
      ...
      <div class="main-content"  >
        <div class="main-content-inner">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="alert alert-block alert-success">
                     ...
                     <center><font face="candara" FONT size="5"> <B>NOMBRE DE DOCUMENT DELIVRES </B></font></center>
                    ...
                    <div class="clearfix">
                     ...
                     <?php 
                                      require_once("../param_connexion_bdd/connexiobddAJAX.php");
                                        ...
                                        $requete="SELECT document_delivre_anactache.iddocdelivre,
                                                         document_delivre_anactache.nomdocdelivre, 
                                                         (COUNT(*)-(SUM(IF(suivi_tache.idstatuttache=5, 1, 0)))) AS tauxexecutionTOTAL,
                                                          ...
                                                          ROUND(((((SUM(IF(suivi_tache.idstatuttache=5, 1, 0)))) / (COUNT(*)))*100),2) AS tauxexecution,
                                                           ...
                                                           FROM suivi_tache,document_delivre_anactache,statut_tache 

                                                           WHERE document_delivre_anactache.iddocdelivre=suivi_tache.documadelivre
                                                            AND document_delivre_anactache.iddocdelivre!=''
                                                             AND statut_tache.idstatuttache=suivi_tache.idstatuttache 
                                                             AND suivi_tache.separer_tache_dj_anac='ANAC'

                                                             GROUP BY document_delivre_anactache.iddocdelivre 

                                                             ORDER BY document_delivre_anactache.nomdocdelivre ";
                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        <thead>
                          <tr>
                            ...
                            <th style="background-color:#03224c;color:white"><center>Documents</center></th>
                            ...
                            <th style="background-color:#03224c;color:white"><center>Total Document Enregistrés</center></th>
         ...
         <td><center><?php echo  $res['nomdocdelivre'];?></center></td>
