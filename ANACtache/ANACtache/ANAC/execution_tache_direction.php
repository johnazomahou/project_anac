...
<script type="text/javascript" src="jquery.min.js" /></script>
 ...
 &nbsp; &nbsp; &nbsp;
                       <a href="consulter_tache_Direction.php" >
...
<center><i style="color:red;font-weight:bold">Les champs marqués d'un astérisques(*) sont obligatoire </i></center>
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <form  method="POST" class="form-horizontal" action="update_execution_tache_Direction.php" role="form" enctype="multipart/form-data">
        ...
        <select  id ="idemetteur" title="Choissisez Expéditeur dans la liste"   style="color:black;font-weight:bold" class=" form-control selectpicker show-tick " data-size="5"  data-header="Faite votre recherche dans cette zone..." data-live-search="true" data-style="btn-danger" class="form-control" name="idemetteur"  data-rel="chosen" required="required">
                    ...
                    <option style="color:black;font-weight:bold" value="<?php echo $nomemetteur['idemetteur'] ?>"
...
<!-- POUR AFFICHER AUTOMATIQUEMENT LA DATE DE CLOTURE QUAND ON CLIQUE LE CHOIX  STATUT=CLOS -->
                    ...
                    <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> <b id="textedatecloture" style="color:red;font-weight:bold"> Date Cloture: </b></label>
                                                    ...
                                                    <input type="date" title="Date Cloture de la tâche"  value="<?php echo $datecloture?>"  name="datecloture"  id="datecloture"  style="color:red;font-weight:bold" class="form-control">
            ...
            <div class="form-group has-success has-feedback">
                                ...
                                <i style="color:red;font-weight:bold">*</i></font></label>
                          <div class="col-sm-3">
                                <input type="date" title="Date Attribution de la tâche" required="required" value="<?php echo $dateattribution?>"  name="dateattribution"  style="color:black;font-weight:bold" class="form-control">
                                    ...
                                    <label class="col-sm-1 control-label"><font color="white">Objet:
                                               <i style="color:red;font-weight:bold">*</i></font></label>
                                                     <div class="col-sm-3">
                                                      ...
                                                      <input type="text"  name="objettache" value="<?php echo $objettache?>" required="required" style="color:#03224c;background-color:white;font-weight:bold"  class="form-control" >
        ...
        <select  id ="idformutilise" title="Choissisez Formulaire utilisé dans la liste"   style="color:black;font-weight:bold" class=" form-control selectpicker show-tick " data-size="5"  data-header="Faite votre recherche dans cette zone..." data-live-search="true" data-style="btn-primary" class="form-control" name="formutilise"  data-rel="chosen">
                    ...
                    <option style="color:black;font-weight:bold" value="<?php echo $nomformulaireutilise['idformutilise'] ?>"
                          ...
                          <div class="col-sm-3">
                                <input type="date" title="Date Provisionnelle Reponse de la tâche" value="<?php echo $dateprovisiore?>"   name="dateprovisiore"  style="color:black;font-weight:bold" class="form-control">
                          </div>
