...
LEFT JOIN direction_anac ON direction_anac.codedirec=service_anac.codedirec
   ...
   WHERE direction_anac.codedirec='$codedirec'  AND  (emetteur_tache.nomemetteur like '%$mc%'  
...
LEFT JOIN direction_anac ON direction_anac.codedirec=service_anac.codedirec
              ...
              WHERE suivi_tache.separer_tache_dj_anac='ANAC' AND  direction_anac.codedirec='$codedirec'
               ORDER BY   suivi_tache.idtache DESC ");
...
LEFT JOIN direction_anac ON direction_anac.codedirec=service_anac.codedirec
                                ...
                                AND suivi_tache.separer_tache_dj_anac='ANAC'   AND  direction_anac.codedirec='$codedirec'  
...
?>
      ...
      <!--POUR METRE LE FORMULAIRE DE RECHECHERE -->
          ...
          <form method="GET" action="consulter_tache_Direction.php">
        ...
        &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp 
                                ...
                                <a title="Pour Afficher la page 0" class="btn btn-warning btn" href="consulter_tache_Direction.php">
...
<!--POUR MISE EN FORME CONDITIONNELLE GERER COULEUr DE FOND du statut d l tache-->
            ...
            echo '<td style="background-color:red;color:white"><a style="color:red;font-weight:bold;color:white" >Ouvert</a></td>';
                     ...
                     echo '<td style="background-color:olive;color:white"><a style="color:red;font-weight:bold;color:white" >Pour Avis</a></td>';
                                      ...
                                      elseif ($idstatuttache=='4')
                                            {
                     echo '<td style="background-color:olive;color:white"><a style="color:red;font-weight:bold;color:white" >En Attente de Validation</a></td>';
                                                       }
      ...
      <!--tableau pour faire le suivi-->
        ...
        echo '<a  title="Suivi de la Tâche" href="execution_tache_direction.php?idtache='.$res["idtache"].'">
     ...
     <div style="margin-left:30%">
      <ul class="nav nav-pills " style="float:center;">
        <?php 
             if($page>0){ ?>        
                  <li   class="active" > <a  href="consulter_tache_Direction.php?motcle=<?php echo $mc;?>&page=<?php echo(0)?>"><< </a></li>

                  <li  class="active" > <a  href="consulter_tache_Direction.php?motcle=<?php echo $mc;?>&page=<?php echo($page-1)?>">< Précédent</a></li>
          <?php } ?>
        <?php 
          $from=0;
          $max_nbre_page=10;
      //ON AFFICHE 10 ENREGISTEMA PAR PAGE
        ...
        <li class="<?php echo(($i==$page)? 'active':''); ?>">
          <a  href="consulter_tache_Direction.php?motcle=<?php echo $mc;?>&page=<?php echo($i)?>"> <?php echo($i)?></a>
        </li>
        <?php } ?>
         <?php 
             if($page<$Nbrepage){ ?>
             <li class="active"><a  href="consulter_tache_Direction.php?motcle=<?php echo $mc;?>&page=<?php echo($page+1)?>">Suivant ></a></li>
             <li class="active"><a  href="consulter_tache_Direction.php?motcle=<?php echo $mc;?>&page=<?php echo($Nbrepage-1)?>">>></a></li>
           <?php } ?>
      </ul>
      </div>
      <?php }?>
