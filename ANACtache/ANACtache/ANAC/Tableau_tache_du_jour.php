    ...
    $requete="SELECT suivi_tache.idtache,emetteur_tache.idemetteur,emetteur_tache.nomemetteur,
                     attributeur_tache.idattributeur,date_format(suivi_tache.datecloture, '%d/%m/%Y') as datecloture,
                                             ...
                                             DATEDIFF(CURRENT_DATE,suivi_tache.dateattribution) AS nbrejourecoule,
                                                  date_format(suivi_tache.dateenrgecouranac, '%d/%m/%Y') as dateenrgecouranac
