...
?>
 ...
 &nbsp; &nbsp; &nbsp;
                       <a href="redirection_insertion_tache_simultanement_joindre_courrier_entree.php" >
      ...
      <form  method="POST" class="form-horizontal" action="update_execution_tache_joindre_courier_entree.php" role="form" enctype="multipart/form-data">
