      ...
      <div class="main-content">
        ...
        <!-- /.POUR INCLURE LE FICHIER REPARTITION DES Analyses Statistiques ANNE EN COURS et precendete pour avoir le taxu dexcution ,suivi -->
            ...
            <?PHP   include_once('tableau_recapt_tache_par_anne.php');?>
              ...
              TABLEAU SYNOPTIQUE DES TACHES ACCUSEES RECEPTION PAR LE RMO
...
if(isset($_GET['motcle'])){
  ...
  //REQUETE POUR COMPTER LE NBRE ENREGISTREMENT QUI ON LA VALEUR DU MOT CLE SAISI
             ...
             WHERE  (emetteur_tache.nomemetteur like '%$mc%'  
                    ...
                    AND statut_tache.idstatuttache='009'
...
?>
      ...
      <!--POUR METRE LE FORMULAIRE DE RECHECHERE -->
          ...
          <form method="GET" action="consulter_tache_ACCUSE_RECEPTION_admin.php">
        ...
        &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp 
                                ...
                                <a title="Pour Afficher la page 0" class="btn btn-warning btn" href="consulter_tache_ACCUSE_RECEPTION_admin.php">
        ...
        &nbsp&nbsp &nbsp &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp 
            ...
            <a target=_black title="Extraction des données" onclick="return confirm('Etes vous sûr de vouloir Extraire ce tableau  au format Excel  ?');"  href="extraction_tache_ACCUSE_RECEPTION_admin.php">
                                                 <b>Extraction</b>
  ...
  <!--POUR MISE EN FORME CONDITIONNELLE GERER COULEUr DE FOND du statut d l tache-->
     ...
     <div style="margin-left:30%">
      <ul class="nav nav-pills " style="float:center;">
        <?php 
             if($page>0){ ?>        
                  <li   class="active" > <a  href="consulter_tache_ACCUSE_RECEPTION_admin.php?motcle=<?php echo $mc;?>&page=<?php echo(0)?>"><< </a></li>

                  <li  class="active" > <a  href="consulter_tache_ACCUSE_RECEPTION_admin.php?motcle=<?php echo $mc;?>&page=<?php echo($page-1)?>">< Précédent</a></li>
          <?php } ?>
        <?php 
          $from=0;
          $max_nbre_page=10;
      //ON AFFICHE 10 ENREGISTEMA PAR PAGE
        ...
        <li class="<?php echo(($i==$page)? 'active':''); ?>">
          <a  href="consulter_tache_ACCUSE_RECEPTION_admin.php?motcle=<?php echo $mc;?>&page=<?php echo($i)?>"> <?php echo($i)?></a>
        </li>
        <?php } ?>
         <?php 
             if($page<$Nbrepage){ ?>
             <li class="active"><a  href="consulter_tache_ACCUSE_RECEPTION_admin.php?motcle=<?php echo $mc;?>&page=<?php echo($page+1)?>">Suivant ></a></li>
             <li class="active"><a  href="consulter_tache_ACCUSE_RECEPTION_admin.php?motcle=<?php echo $mc;?>&page=<?php echo($Nbrepage-1)?>">>></a></li>
           <?php } ?>
      </ul>
      </div>
      <?php }?>
