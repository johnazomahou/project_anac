            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="alert alert-block alert-success">
                     ...
                     <center><font face="candara" FONT size="5"> <B>NOMBRE DOSSIER TRAITES PAR RMO </B></font></center>
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="clearfix">
                     ...
                     <?php 
                                  ...
                                  $requete="SELECT attributeur_tache.nomattributeur,user_anacstat.numat,attributeur_tache.idattributeur,
...
LEFT JOIN document_delivre_anactache ON document_delivre_anactache.iddocdelivre=suivi_tache.documadelivre
              ...
              WHERE   suivi_tache.separer_tache_dj_anac='ANAC'
               ...
               GROUP BY   attributeur_tache.idattributeur
               
               ORDER BY attributeur_tache.nomattributeur ";
                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        <thead>
                          <tr>
                            ...
                            <th style="background-color:#03224c;color:white"><center>RMO</center></th>
                            <th style="background-color:#03224c;color:white"><center>Total Dossier à Suivre</center></th>
                            <th style="background-color:#03224c;color:white"><center>Total Dossier Traités </center></th>
                            <th style="background-color:#03224c;color:white"><center>Total Dossier Enregistrés</center></th>
         ...
         <td><center><?php echo  $res['nomattributeur'];?></center></td>
