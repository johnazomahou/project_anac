            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <form  method="POST" class="form-horizontal" action="update_execution_tache.php" role="form" enctype="multipart/form-data">
...
<!-- POUR AFFICHER AUTOMATIQUEMENT LA DATE DE CLOTURE QUAND ON CLIQUE LE CHOIX  STATUT=CLOS -->
                    ...
                    <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> <b id="textedatecloture" style="color:red;font-weight:bold"> Date Cloture: </b></label>
                                                    ...
                                                    <input type="date" title="Date Cloture de la tâche"  value="<?php echo $date=date('Y-m-d' );?>"  name="datecloture"  id="datecloture" readonly style="color:red;font-weight:bold" class="form-control">
