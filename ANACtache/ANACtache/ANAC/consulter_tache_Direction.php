...
<META HTTP-EQUIV="Refresh" CONTENT="60">
          ...
          //<!--ICI ON CREE LE MENUS ACCESSIBLES PAR LES =ADMISN-->
              ...
              include('graphique_comparative_surdeux_annee_tache_surveillee_DIRECTION_CONNECTE.php');
          ?>
      ...
      <div class="main-content"  >
        <div class="main-content-inner">
          ...
          <div class="page-content">
            ...
            TABLEAU DE BORD DECISIONNEL DE LA

:    <?php echo  ' ' .$_SESSION['user']['libdirec']?>
 ...
 <div class="alert alert-block alert-success">
                     ...
                     <center><font face="candara" FONT size="5"> <B>ANALYSES DES INDICATEURS DE PERFORMANCES DE LA

:    <?php echo  ' ' .$_SESSION['user']['libdirec']?></B></font></center>
...
<center><div id="DivClignotante88" style="visibility:visible;"><font face="candara" FONT size="4"> <B style="color:red">ALERTES DES TACHES A SUIVRENT POUR CE:
               ...
               <?php
                      ...
                      include('Tableau_tache_du_jour_DIRECTION_CONNECTE.php');
...
<h5 class="widget-title" style="color:#03224c;font-weight:bold">
            ...
            Editions des Etats des Tâches par années et par Statuts de la
:    <?php echo  ' ' .$_SESSION['user']['libdirec']?>
        ...
        //    <!--POUR AFFICHER LE TABLEAU PAR STATTUS-->
              ...
              include('stat_edition_etat_directioin_connecte.php');
          ?>
...
<h5 class="widget-title" style="color:#03224c;font-weight:bold">
            ...
            Taux Exécution des Tâches par années et par Statuts de la
:    <?php echo  ' ' .$_SESSION['user']['libdirec']?>
          ...
          //<!--ICI ON CREE LE MENUS ACCESSIBLES PAR LES =Super_Utilisateur-->
              ...
              include_once('tableau_recapt_tache_anne_encours_direction.php');
          ?>
 ...
 <!-- pour gerer les graphiquess -->
        ...
        //<!--POUR AFFICHER LA COURBE A DROITE QUI DONNE LE TAUX DE REALISATION, ET PERSONNALISER LES 2 COURBES-->
              ...
              include('graphique_taux_realisation_DIRECTION_CONNECTE.php');
          ?>
...
<h4 class="widget-title" style="color:#03224c;font-weight:bold">
        ...
        //    <!--POUR AFFICHER LE TABLEAU PAR STATTUS-->
              ...
              include('tablo_tache_menseule_anneecours_direction_connecte.php');
          ?>
...
<hr>
 ...
 TABLEAU SYNOPTIQUE DES TACHES:    <?php echo  ' ' .$_SESSION['user']['libdirec']?>
              ...
              <div class="col-xs-12">
                   ...
                   <?php include('afficher_tableau_tache_enregistre_direction.php');?>
