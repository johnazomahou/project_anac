...
?>
      ...
      <div class="main-content">
        ...
        &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp 
         ...
         <a title="Pour Afficher le tableau Suivi des tache" class="btn btn-warning btn" href="suivi_taches_attribuer_plusieures_personnes.php">
                                ...
                                <a title="Pour attribuer une tâche à plusieurs RMO" class="btn btn-success" href="suivi_taches.php">
                                                <i class="glyphicon glyphicon-plus"> 
              ...
              <div class="col-xs-12">
                  ...
                  <center><a class="green" title="Joindre Courrier d'entrée..." onclick="return confirm('Etes vous sur de vouloir Joindre le Courrier entrée?')"
                    href="joindre_courrier_entree_insertion_plusieur_attriubuteur.php?numeroodre=<?php echo $res['numeroodre'] ?>">
